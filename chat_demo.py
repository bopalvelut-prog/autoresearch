"""
AutoResearch Chat Demo
Uses the best record numbers to train a model and then generate text.
"""
...
DEPTH = 2
DEVICE_BATCH_SIZE = 4
TIME_BUDGET = 600 # 10 MINUTES for better results
...
print("Training for 10 minutes to learn some language patterns...")
t_start = time.time()
step = 0
